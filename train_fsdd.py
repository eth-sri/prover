...
def train_model(epochs=100, lr=0.001, batch_size=30):
    ...
    train_loader = fsdd_loader.DataStream("train", batch_size)
    print("Test data loading")
    valid_loader = fsdd_loader.DataStream("test", batch_size)
    model = SpeechClassifier(256, 200, 10, 40, 32, 2, 10, batch_size, 8000).to(
    ...
    for epoch in range(epochs):
        ...
        torch.save(model.state_dict(), "saved/fsdd.pt")
